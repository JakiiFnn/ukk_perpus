            ...
            <div class="col-md-12">
                ...
                $id = $_GET['id'];  
                 if(isset($_POST['submit'])) {
                    ...
                    $ulasan = $_POST['ulasan'];
                    $rating = $_POST['rating'];
                    $query = mysqli_query($koneksi, "UPDATE ulasan set id_buku='$id_buku',id_user='$id_user',ulasan='$ulasan',rating='$rating' WHERE id_ulasan=$id ");
